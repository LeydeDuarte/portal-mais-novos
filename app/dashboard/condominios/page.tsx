      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-8 md:px-8">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 flex-wrap justify-end gap-2">
            {veTudo(staff.role) && (
              <Link
                href="/dashboard/condominios/duplicados"
            ...
            <Link href="/dashboard/condominios/importar" className="rounded-full border border-[var(--border)] px-4 py-2 text-sm font-bold hover:bg-[var(--pill-bg)]">
              Importar planilha
            </Link>
            ...
            {lista.slice(0, limite).map((c) => (
              <div key={c.id} className="flex items-center justify-between gap-4 rounded-xl border border-[var(--border)] p-4">
                ...
                <div className="flex shrink-0 items-center gap-3">
                  ...
                  <Link
                    href={`/dashboard/condominios/${c.id}/editar`}
                  ...
                  <Link href={`/dashboard/propostas/nova?condominio=${c.id}`} className="rounded-full border border-[var(--border)] px-3.5 py-1.5 text-sm font-bold hover:border-accent">
                    Proposta
                  </Link>
                </div>
              </div>
