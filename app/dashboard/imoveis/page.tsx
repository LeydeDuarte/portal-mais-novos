            ...
            {visiveis.map((p) => (
              <div key={p.id} className="flex items-center justify-between gap-4 rounded-xl border border-[var(--border)] p-4">
                ...
                <div className="flex shrink-0 flex-wrap items-center justify-end gap-x-3 gap-y-2">
                  ...
                  <Link href={`/dashboard/imoveis/${p.id}/editar`} className="rounded-full bg-ink px-3.5 py-1.5 text-sm font-bold text-white hover:opacity-90">
                    Editar
                  </Link>
                  <Link href={`/dashboard/propostas/nova?imovel=${p.id}`} className="rounded-full border border-[var(--border)] px-3.5 py-1.5 text-sm font-bold hover:border-accent">
                    Proposta
                  </Link>
